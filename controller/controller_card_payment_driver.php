<?php 
    ...
    //INSERT DATA TO THE PAYMENT TABLE
        ...
        if($dataPay ==true){
            ...
            '<br>'.'<br>';
            echo "or".'<br>'.'<br>';
            echo '<button class="upd" style="background-color:green; border:none; padding: 7px 9px;">'.'<a href="payment.php" style="color: white; text-decoration:none;">'.'All Payment List'.'</a>'.'</button>'.
            '<br>'.'<br>';
        }
    }