<?php
     ...
     require "controller/controller_change_fleet.php";
?>
        ...
        <div class="the_inputs">
            <div class="inputs_left">
                ...
                <select hidden name="kind_of_registration" id="kind_of_registration">
                    <option value="new">new courier</option>
                    <option value="changed" selected>changed fleet</option>
                </select>
            </div>
            <div class="inputs_left">
        ...
        <div class="the_inputs">
         ...
         <div class="the_inputs">
            ...
            <div class="inputs_left">
                ...
                <input type="hidden" name="bank_account" id="bank-account" placeholder="bank-account">
