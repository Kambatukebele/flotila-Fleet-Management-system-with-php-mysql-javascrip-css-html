<?php require "includes/head/head.php"; ?>
        ...
        <div class="main_all">
            <div class="main_text_heading">
                ...
                <div class="main_button">
                    <a href="registration"><button class="btn_green">Zaregistruj se</button></a>
                    <a href="contact"><button class="btn_white">Kontaktuj nás</button></a>
                </div>
            </div>
    
            <div class="main_image">
                <img src="/assets/flotila/images/driver.jpg" alt="driver_image">
            </div>
        </div>
    </main>
    ...
    <section class="work_now">
       <div class="work_now_all">
            <div class="work_now_button">
                <button><a href="registration">Zaregistruj se</a></button>
            </div>
       </div>
    </section>
    ...
    <section class="bonus">
        <div class="bonus_all">
            ...
            <button><a href="bonus">Více</a></button>
        </div>
    </section>
            ...
            <div class="application_box_left">
                ...
                <div class="application_dowload">
                    <div class="application_android">
                        <a href="https://play.google.com/store/apps/details?id=com.bolt.deliverycourier"><img src="/assets/flotila/images/android.jpeg" alt=""></a>
                    </div>
                    <div class="application_apple">
                        <a href="https://apps.apple.com/cz/app/bolt-courier/id1470629849?l=cs"><img src="/assets/flotila/images/apple.jpeg" alt=""></a>
                    </div>
                </div>
            </div>
            <div class="application_img">
                <img src="/assets/flotila/images/boltimg.jpeg" alt="">
            </div>
        </div>
    </section>
    <!-- ========== FOOTER ========== -->
