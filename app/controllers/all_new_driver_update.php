<?php
    require_once 'controller/controller_all_new_driver_update.php';
                            ...
                            <div class="table-responsive">
                                <form action="" method="POST">
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr>
                                                    <td><input type="text" name="send_registration" value="<?php echo $stmt[0]['sent_registration']; ?>"></td>
